export default class tinydsaItemSheet extends ItemSheet {
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            classes: [ "tinydsa", "sheet", "item", game.settings.get("tinydsa", "theme") ]
        });
    }

    get template() {
        return `systems/tinydsa/templates/sheets/${this.entity.data.type}-sheet.hbs`;
    }
