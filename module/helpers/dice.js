export async function RollTest({
    ...
    let renderedRoll = await renderTemplate("systems/tinydsa/templates/partials/test-result.hbs", { rollResult: result });
    // let renderedRoll = await result.render({ result: result, template: "systems/tinydsa/templates/partials/test-result.hbs" });
